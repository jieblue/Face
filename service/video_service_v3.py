...
from service import video_validator, basic_algorithm_service
...
def process_video_file(video_file: VideoFile):
    ...
    logger.info("Key frame list extracted.")

    # 提出视频关键帧中的人脸关键帧集合
    face_frame_list = visual_algorithm_service.extract_face_list(key_frame_list)
    logger.info("Face frame list extracted. {}")

    # 将视频关键帧进行转换， 提取视频关键帧特征集合
