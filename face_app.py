...
image_faces_v1 = Collection(image_faces_v1_name, schema)
# 主头像二级人像库
main_avatar_v1 = Collection(face_app_conf["main_avatar_collection"], schema)
...
def face_vectorization():
    ...
    try:
        ...
        # logger.info("image_faces_v1.insert res:", res)
...
def update_main_avatar():
    ...
    if file:
        ...
        embedding = face_model.turn2embeddings(img1, enhance=False)
        main_avatar_v1.update_entity_by_id(uuid_filename, {
